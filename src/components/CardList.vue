...
<template>
  <div class="p-5">
    <div class="bg-dark text-white p-3 mb-3 fw-bold fs-4">Found {{ store.paginationInfo.current_rows }} results</div>
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3">
        <div class="col" v-for="singleCard in store.cards" :key="singleCard.id">
